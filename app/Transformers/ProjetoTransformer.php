...
{	
	protected $defaultIncludes = ['membros', 'clientes'];
	...
	public function includeClientes(Project $projeto)
    {
        $cliente = $projeto->cliente;
        return $this->collection($cliente, new ClientesProjetoTransformer);
    }
